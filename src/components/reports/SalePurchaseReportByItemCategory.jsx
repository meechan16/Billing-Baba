...
export default function SalePurchaseReportByItemCategory({ data, setData }) {
  ...
  const columns = [
    { key: "Name", label: "Item Categor" },
    { key: "moneyInn", label: "Sale Quantity" },
    { key: "moneyInn", label: "Total Sale Amount" },
    { key: "moneyInn", label: "Purchase Quantity" },
    { key: "moneyInn", label: "Total Purchase Amount" },
    { key: "moneyInn", label: "Total Purchase Amount" },
    // { key: "DropDown", label: "-" },
  ];
