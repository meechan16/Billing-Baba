...
export default function StockDetails({ data, setData }) {
  ...
  const columns = [
    ...
    { key: "stock", label: "Begining Quantity" },
    { key: "moneyInn", label: "Quantity In" },
    { key: "moneyInn", label: "Purchase Amount" },
    { key: "moneyInn", label: "Quantity Out" },
    { key: "moneyInn", label: "Sale Amount" },
    { key: "stock", label: "Closing Quantity" },
    // { key: "DropDown", label: "-" },
  ];
